...
// 各音素材のパラメータ
CSound::PARAM  CSound::m_aParam[SOUND_MAX] =
{
	{ "data/sound/BGM/Game.wav", -1 },	//ゲームのBGM	
	{ "data/sound/BGM/Result.wav", -1 }, //resultのBGM
	{ "data/sound/BGM/Title.wav", -1 }, //タイトルのBGM
	{ "data/sound/SE/Explosion.wav", 0 }, //爆発
	{ "data/sound/SE/SELECT.wav", 0 }, //選択肢選択
	{ "data/sound/SE/SELECT_Decision.wav", 0 }, //選択肢決定
	{ "data/sound/SE/Shoot.wav", 0 }, //弾
...
HRESULT CSound::Init(HINSTANCE hInstance, HWND hWnd)
...
HRESULT CSound::PlaySound(SOUND label)
{
...
void CSound::StopSound(SOUND label)
{
	XAUDIO2_VOICE_STATE xa2state;
